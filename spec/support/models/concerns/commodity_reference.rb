RSpec.shared_examples 'commodity reference' do |indexed: true|
  context 'table structure' do
    ...
    it { is_expected.to have_db_index(:product_id) } if indexed
    ...
    it { is_expected.to have_db_index(:variant_id) } if indexed
  end
